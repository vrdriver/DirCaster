 ...
 */
   ...
   *           Scan for media file overrides in the location specified by
  ...
  */
   ...
   * You can place you files in a sub-directory
 ...
 */
  ...
  $year = date("Y");
  $copyrightTAG="Copyright 20xx-" . $year . ", Your Name, All Rights Reserved.";
//  $copyrightTAG   = "Copyright 20xx, Your Name, All Rights Reserved.";
  // Podcast Language Tag
  $languageTAG    = "en-us";
  // Site Webmaster E-mail Address
  $webMasterTAG   = "Your Email";
  // Give The DirCaster Project some "props!"
  $generatorTAG   = "DirCaster V1.0 - www.DirCaster.org";
  // "Time to Live"
  $ttlTAG         = "60";
  ...
  // To satisfy the feed validator. Make $atomNameSpace = '' to drop Atom
  $nameSpaceTAG = $iTunesNameSpace . ' ' . $atomNameSpace;
  //
  //-- Explicit Tag options: "yes" = IS Explicit, "no" = Not saying one way or
